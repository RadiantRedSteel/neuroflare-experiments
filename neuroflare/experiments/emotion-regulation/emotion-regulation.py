...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='D:\\Github\\neuroflare-experiments\\neuroflare\\experiments\\emotion-regulation\\emotion-regulation.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    t_emotion_regulation_cue = visual.TextStim(win=win, name='t_emotion_regulation_cue',
        text='',
        font='Arial',
        pos=(0.0, 0.05), draggable=False, height=0.12, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-2.0);
